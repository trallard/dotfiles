# Generated by Powerlevel10k configuration wizard on 2020-06-19 at 10:36 BST.
...
() {
  ...
  #  resetting to default - https://github.com/Powerlevel9k/powerlevel9k
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=5
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND85
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=217
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=211
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:+$P9K_ANACONDA_PYTHON_VERSION ${CONDA_PREFIX:t}}'
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=218
  ...
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND=111
  # Custom icon.
